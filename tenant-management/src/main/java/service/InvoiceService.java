...
public class InvoiceService {
    ...
    public Invoice createInvoice(InvoiceCreateDto invoiceCreateDto) {
        ...
        Invoice invoice = new Invoice(invoiceCreateDto.getInvoiceDate(), invoiceCreateDto.getInvoiceAmount(), invoiceCreateDto.getDescription(), invoiceCreateDto.getStatus(), invoiceCreateDto.getReceiver(), invoiceCreateDto.getReceiverIban(), invoiceCreateDto.getReceiverBic(), invoiceCreateDto.getExternalInvoiceNumber(), invoiceCreateDto.getCurrency(),Boolean.parseBoolean(invoiceCreateDto.getRelevantForAnnualStatement()), invoiceCategory, housingObject);
